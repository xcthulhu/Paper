...
\cite{marcus72}\otodo{First order
...
however I think you should note this solution to the problem
somewhere, especially if Dutch people are going to look at this}
an alternative substitutional quantifier, popularized by Saul Kripke
\cite{kripke} and Ruth Barcan Marcus.  The
